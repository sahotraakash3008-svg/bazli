...
export interface Order {
  ...
  review?: OrderReview; // Customer shopping & delivery experience rating
}
...
export interface Seller {
  ...
  commissionRate?: number; // Standard 10% for connected 3rd party sellers
  joinedDate?: string; // Date joined (YYYY-MM-DD or ISO string) used for 2-month 0% commission welcome offer
  createdAt?: string;
  totalCommissionPaid?: number; // Total commission deposited into Bazli Admin account
